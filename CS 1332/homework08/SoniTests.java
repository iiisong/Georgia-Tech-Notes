...
public class SoniTests {
    ...
    public void selectionSortExceptions() {
        integers = new SoniTests.IntegerWrapper[8];
    ...
    public void kthSelectExceptions() {
        integers = new SoniTests.IntegerWrapper[1];
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    public void selectionSort1() {
        integers = new SoniTests.IntegerWrapper[10];
        integers[0] = new SoniTests.IntegerWrapper(9);
        integers[1] = new SoniTests.IntegerWrapper(5);
        integers[2] = new SoniTests.IntegerWrapper(30);
        integers[3] = new SoniTests.IntegerWrapper(5);
        integers[4] = new SoniTests.IntegerWrapper(7);
        integers[5] = new SoniTests.IntegerWrapper(1);
        integers[6] = new SoniTests.IntegerWrapper(-3);
        integers[7] = new SoniTests.IntegerWrapper(2);
        integers[8] = new SoniTests.IntegerWrapper(50);
        integers[9] = new SoniTests.IntegerWrapper(30);

        sortedIntegers = new SoniTests.IntegerWrapper[10];
        sortedIntegers[0] = new SoniTests.IntegerWrapper(-3);
        sortedIntegers[1] = new SoniTests.IntegerWrapper(1);
        sortedIntegers[2] = new SoniTests.IntegerWrapper(2);
        sortedIntegers[3] = new SoniTests.IntegerWrapper(5);
        sortedIntegers[4] = new SoniTests.IntegerWrapper(5);
        sortedIntegers[5] = new SoniTests.IntegerWrapper(7);
        sortedIntegers[6] = new SoniTests.IntegerWrapper(9);
        sortedIntegers[7] = new SoniTests.IntegerWrapper(30);
        sortedIntegers[8] = new SoniTests.IntegerWrapper(30);
        sortedIntegers[9] = new SoniTests.IntegerWrapper(50);
    ...
    public void selectionSort2() {
        integers = new SoniTests.IntegerWrapper[2];
        integers[0] = new SoniTests.IntegerWrapper(0);
        integers[1] = new SoniTests.IntegerWrapper(-1);

        sortedIntegers = new SoniTests.IntegerWrapper[2];
        sortedIntegers[0] = new SoniTests.IntegerWrapper(-1);
        sortedIntegers[1] = new SoniTests.IntegerWrapper(0);
    ...
    public void cocktailSort1() {
        integers = new SoniTests.IntegerWrapper[10];
        for (int i = 0; i < 10; i++) {
            integers[i] = new SoniTests.IntegerWrapper(9 - i);
        }

        sortedIntegers = new SoniTests.IntegerWrapper[10];
        for (int i = 0; i < 10; i++) {
            sortedIntegers[i] = new SoniTests.IntegerWrapper(i);
        }
    ...
    public void cocktailSort2() {
        ...
        integers = new SoniTests.IntegerWrapper[4];
        integers[0] = a;
        integers[1] = b;
        integers[2] = c;
        integers[3] = d;

        sortedIntegers = new SoniTests.IntegerWrapper[4];
        sortedIntegers[0] = d;
        sortedIntegers[1] = a;
        sortedIntegers[2] = b;
        sortedIntegers[3] = c;
    ...
    public void kthSelect2() {
        int randomSeed = 15;
        integers = new SoniTests.IntegerWrapper[100];
        for (int i = 0; i < 100; i++) {
            integers[i] = new SoniTests.IntegerWrapper(99 - i);
        }
    ...
    public void kthSelect3() {
        int randomSeed = 15;
        integers = new SoniTests.IntegerWrapper[20];
        for (int i = 0; i < 20; i++) {
            integers[i] = new SoniTests.IntegerWrapper(0);
        }
