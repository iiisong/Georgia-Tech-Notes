...
(0,24,'1#1#55000.0000############'),
(0,24,'4#3#31000.0000############'),
(0,25,'computerization#10#3############'),
(0,25,'newbenefits#30#3############'),
(0,25,'productx#1#2############'),
(0,25,'producty#2#3############'),
(0,25,'productz#3#2############'),
(0,25,'reorganization#20#3############'),
(0,26,'computerization#10#3############'),
(0,26,'newbenefits#30#3############'),
(0,26,'producty#2#3############'),
(0,26,'reorganization#20#3############'),
(0,27,'computerization#10#1############'),
(0,27,'newbenefits#30#0############'),
(0,27,'productx#1#2############'),
(0,27,'producty#2#3############'),
(0,27,'productz#3#2############'),
(0,27,'reorganization#20#1############'),
(0,28,'1#1#############'),
(0,28,'4#1#############'),
...
(1,15,'research#smith#john#productz###########'),
(1,15,'research#wong#franklin#productx###########'),
...
(1,15,'research#english#joyce#productz###########'),
(1,15,'research#narayan#ramesh#productx###########'),
(1,15,'research#narayan#ramesh#producty###########'),
...
(1,25,'producty#2#3############'),
(1,25,'productz#3#2############'),
(1,25,'reorganization#20#2############'),
(1,26,'producty#2#3############'),
(1,27,'productx#1#2############'),
(1,27,'producty#2#3############'),
(1,27,'productz#3#2############'),
(1,27,'reorganization#20#1############'),
(1,28,'1#1#############'),
...
(2,24,'1#1#55000.0000############'),
(2,24,'4#3#31000.0000############'),
(2,25,'computerization#10#2############'),
(2,25,'newbenefits#30#3############'),
(2,25,'reorganization#20#2############'),
(2,26,'newbenefits#30#3############'),
(2,27,'computerization#10#0############'),
(2,27,'newbenefits#30#0############'),
(2,27,'reorganization#20#0############'),
(2,28,'1#1#############'),
(2,28,'4#1#############'),
...
(3,15,'research#smith#john#productz###########'),
(3,15,'reverseengineering#jackson#camila#hindsight###########'),
(3,15,'reverseengineering#cuevas#hector#hindsight###########'),
(3,15,'research#wong#franklin#productx###########'),
(3,15,'research#wong#franklin#producty###########'),
(3,15,'research#wong#franklin#productz###########'),
(3,15,'reverseengineering#weiss#heike#hindsight###########'),
(3,15,'research#english#joyce#productx###########'),
(3,15,'research#english#joyce#producty###########'),
(3,15,'research#english#joyce#productz###########'),
(3,15,'reverseengineering#watanabe#hiroto#hindsight###########'),
(3,15,'research#narayan#ramesh#productx###########'),
(3,15,'research#narayan#ramesh#producty###########'),
...
(3,15,'administration#wallace#jennifer#computerization###########'),
...
(3,24,'1#1#55000.0000############'),
(3,24,'4#3#31000.0000############'),
(3,25,'computerization#10#3############'),
(3,25,'hindsight#55#3############'),
(3,25,'newbenefits#30#3############'),
(3,25,'productx#1#2############'),
(3,25,'producty#2#3############'),
(3,25,'productz#3#2############'),
(3,25,'reorganization#20#3############'),
(3,26,'computerization#10#3############'),
(3,26,'hindsight#55#3############'),
(3,26,'newbenefits#30#3############'),
(3,26,'producty#2#3############'),
(3,26,'reorganization#20#3############'),
(3,27,'computerization#10#1############'),
(3,27,'hindsight#55#0############'),
(3,27,'newbenefits#30#0############'),
(3,27,'productx#1#2############'),
(3,27,'producty#2#3############'),
(3,27,'productz#3#2############'),
(3,27,'reorganization#20#1############'),
(3,28,'1#1#############'),
(3,28,'4#1#############'),
...
(4,15,'research#smith#john#productz###########'),
(4,15,'research#wong#franklin#productx###########'),
...
(4,15,'research#english#joyce#productz###########'),
(4,15,'research#narayan#ramesh#productx###########'),
(4,15,'research#narayan#ramesh#producty###########'),
(4,15,'research#narayan#ramesh#productz###########'),
(4,15,'headquarters#borg#james#reorganization###########'),
(4,15,'administration#wallace#jennifer#computerization###########'),
...
(4,24,'1#1#55000.0000############'),
(4,24,'4#3#37000.0000############'),
(4,25,'computerization#10#3############'),
(4,25,'newbenefits#30#3############'),
(4,25,'productx#1#2############'),
(4,25,'producty#2#3############'),
(4,25,'productz#3#2############'),
(4,25,'reorganization#20#3############'),
(4,26,'computerization#10#3############'),
(4,26,'newbenefits#30#3############'),
(4,26,'producty#2#3############'),
(4,26,'reorganization#20#3############'),
(4,27,'computerization#10#1############'),
(4,27,'newbenefits#30#0############'),
(4,27,'productx#1#2############'),
(4,27,'producty#2#3############'),
(4,27,'productz#3#2############'),
(4,27,'reorganization#20#1############'),
(4,28,'1#1#############'),
(4,28,'4#3#############'),
